...
public class x4 implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        addClickHandler(img13);
        addClickHandler(img14);
        addClickHandler(img15);
        addClickHandler(img16);
        addClickHandler(img17);
        addClickHandler(img18);
        addClickHandler(img19);
        addClickHandler(img20);
    }
    ...
    private void insPerc()
    {
        ...
        celle.get(12).setPercorso("/genoa.png");
        celle.get(13).setPercorso("/genoa.png");
        celle.get(14).setPercorso("/lazio.png");
        celle.get(15).setPercorso("/lazio.png");
        celle.get(16).setPercorso("/bologna.png");
        celle.get(17).setPercorso("/bologna.png");
        celle.get(18).setPercorso("/torino.png");
        celle.get(19).setPercorso("/torino.png");
